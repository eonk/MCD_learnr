...
**visualise data: ggplot2 package**
...
**transform a numeric variables into a categorical variables**
...
question_text(
  ...
  Ok, so the data name is 'prison', a numeric variable is 'gdpPercap', a new categorical varaible is 'high_low_gdp', and you are creating the value is 'high_gdp' using the mean value, 11888.5. 
